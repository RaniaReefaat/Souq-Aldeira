//
//  VerifyProfilePhoneViewController.swift
//  Najat
//
...
class VerifyProfilePhoneViewController: BaseController {
    ...
    private lazy var viewModel: VerifyProfilePhoneViewModel = {
        VerifyProfilePhoneViewModel(coordinator: coordinator)
    }()
...
extension VerifyProfilePhoneViewController: UITextFieldDelegate {
...
extension VerifyProfilePhoneViewController {
